...
4. **Run the Initialization Script**
   GreenLensAI comes with a convenient startup script that checks prerequisites and launches all services.
   ```bash
...
1. The **Backend** will be live at `http://localhost:8000`.
2. The **Frontend** will be served at `http://localhost:3000`.
3. Your default browser will automatically open the **Login Page**.
